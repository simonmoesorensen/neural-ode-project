...
def run(plot=True, lat_vis=True,z_idx=None):
    ...
    data_lab_path= ['data_lab_[1].npy','data_lab_[2].npy',  'data_lab_[3].npy', 'data_lab_[1 2].npy', 'data_lab_[1 3].npy',  'data_lab_[2 3].npy','data_lab_[1 2 3].npy']
    data_path= ['samp_trajs[1].npy','samp_trajs[2].npy',  'samp_trajs[3].npy', 'samp_trajs[1 2].npy', 'samp_trajs[1 3].npy',  'samp_trajs[2 3].npy','samp_trajs[1 2 3].npy']
    lat_data = []
    lat_lab = []
